export const environment = {
    ...
    geminiApiUrl : 'https://generativelanguage.googleapis.com/v1/models/gemini-1.5-pro:generateContent',
    googleGeminiApiKey:'AIzaSyAkhwxtjQk0HM5NcI69S2LLaPZSiOpFeB0'
};
